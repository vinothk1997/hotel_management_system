                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="room_no" id="" onkeypress="return isTextKey(event)"
                            class="form-control  @error('room_no') is-invalid @enderror" value="{{$room->room_no }}">
                        @error('room_no')
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="no_of_beds" id="" onkeypress="return isTextKey(event)"
                            class="form-control  @error('no_of_beds') is-invalid @enderror" value="{{$room->no_of_beds}}">
                        @error('no_of_beds')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="no_of_bathrooms" id="" onkeypress="return isTextKey(event)"
                            class="form-control  @error('no_of_bathrooms') is-invalid @enderror" value="{{ $room->no_of_bathrooms }}">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="width" id="" onkeypress="return isTextKey(event)"
                            class="form-control  @error('width') is-invalid @enderror" value="{{$room->width}}">
                        @error('width')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="length" id="" onkeypress="return isTextKey(event)"
                            class="form-control  @error('width') is-invalid @enderror" value="{{ $room->length}}">
                        @error('length')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="no_of_chairs" id="" onkeypress="return isTextKey(event)"
                            class="form-control  @error('no_of_chairs') is-invalid @enderror" value="{{$room->no_of_chairs}}">
                        @error('no_of_chairs')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="no_of_tables" id="" onkeypress="return isTextKey(event)"
                            class="form-control  @error('no_of_tables') is-invalid @enderror" value="{{ $room->no_of_tables }}">
                        @error('no_of_tables')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
